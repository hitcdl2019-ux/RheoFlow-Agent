...
# ---------------------------------------------------------------------------
FOAMAGENT_REPO="${RHEOFLOW_AGENT_REPO:-https://github.com/hitcdl2019-ux/RheoFlow-Agent.git}"

if [ "${FOAMAGENT_SKIP_UPDATE:-0}" != "1" ]; then
    echo "[entrypoint] Updating RheoFlow-Agent from GitHub ..."
...
echo "=========================================="
echo "RheoFlow-Agent Docker Container Ready!"
echo "=========================================="
