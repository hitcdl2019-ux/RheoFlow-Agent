...
from utils import remove_files, remove_file, remove_numeric_folders, remove_processor_folders, run_command, check_foam_errors
...
def run_allrun_and_collect_errors(
    ...
    remove_processor_folders(case_dir)
    ...
    for attempt in range(1, max_retries + 1):
        ...
        run_command(allrun_file_path, out_file, err_file, case_dir, timeout, channel)
...
def run_simulation_local(
    ...
    """
    errors = run_allrun_and_collect_errors(case_dir, timeout, max_retries, channel)
